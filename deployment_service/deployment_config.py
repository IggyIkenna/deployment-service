...
class DeploymentConfig(UnifiedCloudConfig):
    ...
    write_quota_buffer: int = Field(
        ...
        description="Reserve for other workloads; effective = WRITE_QUOTA_PER_MINUTE - WRITE_QUOTA_BUFFER",
    )
    ...
    workspace_root: str = Field(
        ...
        description="Absolute path to the workspace root (mono/multi-repo root). Used for local dev pyproject.toml lookups.",
    )
