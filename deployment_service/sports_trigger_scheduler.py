...
from .sports_trigger_evaluation import (
    ...
    max_post_match_lookback_hours as _max_post_match_lookback_hours_fn,
)
...
# TriggerEvent + TriggerState now live in sports_trigger_evaluation.py (imported
# above) — re-exported here for existing `from .sports_trigger_scheduler import
# TriggerState` call sites.
...
class SportsTriggerScheduler:
    ...
    def _max_post_match_lookback_hours(self) -> float:
        """Thin wrapper — see ``sports_trigger_evaluation.max_post_match_lookback_hours``
        (extracted 2026-07-30 to keep this module under the 930-line codex cap).
        """
        return _max_post_match_lookback_hours_fn(self._config, MATCH_END_OFFSET_MIN)
    ...
    def evaluate_pre_match_triggers(
        ...
        """Thin wrapper — see ``sports_trigger_evaluation.evaluate_pre_match_triggers``
        (extracted 2026-07-30 to keep this module under the 930-line codex cap).
        """
    ...
    def evaluate_post_match_triggers(
        ...
        """Thin wrapper — see ``sports_trigger_evaluation.evaluate_post_match_triggers``
        (extracted 2026-07-30 to keep this module under the 930-line codex cap).
        """
