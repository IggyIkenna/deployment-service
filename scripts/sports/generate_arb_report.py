...
def _load_from_local(local_dir: Path) -> tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
...
def main() -> None:
    ...
    parser.add_argument(
        "--output", type=str, default="Football_Betting_Liquidity_Report.html", help="Output HTML file path"
    )
