...
_launch() {
    ...
    # separate from lc_write_launch_params above, which persists the RESUME scope.
...
echo ""
echo "Reminder: post-backfill, run manifest reconciliation (ADDITIVE merge only —"
...
echo "    merge_manifest_from_canonical_paths('market-data-tick-${ASSET_GROUP}-central-element-323112', \\"
