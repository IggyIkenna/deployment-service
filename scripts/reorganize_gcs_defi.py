...
DeFi venues: UNISWAPV2-ETHEREUM, UNISWAPV3-ETHEREUM, UNISWAPV4-ETHEREUM, AAVEV3-ETHEREUM, MORPHO-ETHEREUM, LIDO-ETHEREUM, ETHERFI-ETHEREUM, ETHENA-ETHEREUM
...
def extract_venue_from_filename(filename):
    ...
    - AAVEV3-ETHEREUM:A_TOKEN:USDC@ETHEREUM.parquet -> AAVEV3-ETHEREUM
