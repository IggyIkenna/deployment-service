...
- `unified-trading-pm/workspace-manifest.json` defines *what code components exist and their DAG/dependencies*.
- `runtime-topology.yaml` defines *how runtime interaction happens* (service flows, API interactions, storage patterns, transport by mode/profile).
