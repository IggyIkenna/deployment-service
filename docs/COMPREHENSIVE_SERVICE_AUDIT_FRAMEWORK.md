...
|----------|-------|-------|
| 1. Cloud-Agnostic | __/20 | |
| 2. Path Format | __/20 | |
| 3. Testing | __/20 | |
| 4. Startup Validation | __/15 | |
| 5. Dependency Validation | __/15 | |
| 6. Failure Testing | __/10 | |
| **TOTAL** | **__/100** | |
...
| features-delta-one | __/100 | ❓ | Not done | TBD |
| features-calendar | __/100 | ❓ | Partial | TBD |
| features-onchain | __/100 | ❓ | Not done | TBD |
| features-volatility | __/100 | ❓ | Not done | TBD |
| ml-training | __/100 | ❓ | Not done | TBD |
| ml-inference | __/100 | ❓ | Not done | TBD |
| strategy | __/100 | ❓ | Not done | TBD |
| execution | __/100 | ❓ | Not done | TBD |
